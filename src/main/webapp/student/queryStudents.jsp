...
<div class="container">
    ...
    <form action="${path}/student_showLike" method="post" id="queryForm">
        ...
        <div class="input-append" style="padding-left:40px">
            ...
            <button class="btn" type="submit" style="margin-left: 10px; border-radius:10px;"><a
                    href="${path}/student/add.jsp">添加</a></button>
        </div>
    </form>
    <!-- 模糊查询结束 -->
    <table class="table table-hover" style="height: 250px;">
        ...
        <tr>
            <th style="text-align: center;"><a href="javascript:void(0)"
                                               style="text-decoration: none; text-align: c">学号</a></th>

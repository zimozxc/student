...
<div class="container" style="width: 500px;">
    <h3>修改信息</h3>
    <form class="form-horizontal form-actions" action="${path}/student_update?id=" method="post" id="for">
        <div style="font-size: 18px;font-family:黑体;">学生姓名：</div>
        <div class="control-group">
            <input type="text" name="name" value="小虎"  />
        </div>
        <!-- -->
        <div style="font-size: 18px;font-family:黑体;">学生性别：</div>
        <div class="control-group">
            <input type="radio" name="sex" value="m" checked />男&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="sex" value="f" readonly/>女
        </div>
        <!-- -->
        <div style="font-size: 18px;font-family:黑体;">联系电话：</div>
        <div class="control-group">
            <input type="text" name="mobile" value="13656785678" />
        </div>
        <!-- -->

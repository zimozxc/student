...
<div class="container">
    <form action="${path}/teacher_showLike" method="post" id="queryForm">
        ...
        <div class="input-append" style="padding-left:40px">
            ...
            <input value="" class="span2" type="text" placeholder="请输入名称" name="name" style="width: 250px; height: 30px;margin-left: 10px; border-radius:4px;">&nbsp;
    ...
    <table class="table table-hover" style="height: 250px;">
        ...
        <tr>
            <th style="text-align: center;"><a href="javascript:void(0)"   style="text-decoration: none; text-align: center;">教师用户名</a></th>
        ...
        <tr style="display: none;"><th colspan="8">
            <div id="null">
                ...
                <div style="font-size: 15px; margin-top: 6px"><a href="#" style="text-decoration: none; margin-left: 100px;">那我添加一条</a></div>
            </div>
        </th>
